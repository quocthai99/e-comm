...
const Footer = () => {
    return (
        <div className="w-full ">
            <div className="flex items-center justify-center h-[103px] w-full bg-primary">
                <div className="w-main flex items-center justify-between ">
                    ...
                    <div className="flex-1 flex items-center">
                        <input
                            className="p-4 pr-0 w-full rounded-l-full bg-white outline-none text-text placeholder:text-sm placeholder:text-text placeholder:italic placeholder:opacity-50 "
                            type="text"
                            placeholder="Email address"
                        />
                        <div className="h-[56px] w-[56px] bg-sky-300 rounded-r-full flex items-center justify-center text-white ">
                            <MdEmail size={18} />
                        </div>
                    </div>
                </div>
